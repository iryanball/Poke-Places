...
//  Poke Places
//
//  Created by Ryan Ball on 27/07/2016.
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    @IBAction func dropPokeStop(_ sender: AnyObject) {
        
    }
    
    @IBAction func dropGym(_ sender: AnyObject) {
        
    }
    
    @IBAction func centerMapOnUser(_ sender: AnyObject) {
